...
const MapDrawingPage: React.FC = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-muted">
        <div className="bg-card rounded-card shadow-card p-8 max-w-md text-center">
          ...
          <button
            ...
            className="px-6 py-2 bg-brand text-white rounded-button hover:bg-brand-hover transition-colors"
          >
  ...
  return (
    <div className="min-h-screen bg-muted py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Instructions */}
        <div className="bg-card rounded-card shadow-card p-6 mt-6">
