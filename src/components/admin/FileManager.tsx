  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            {currentPath.split('/').map((folder, index, array) => (
              <React.Fragment key={index}>
                <svg className="w-4 h-4 text-faint-foreground" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
        ...
        <div className="bg-danger-soft border border-danger/30 rounded-card p-4">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="ml-auto text-danger hover:text-danger-strong"
            >
              Dismiss
            </button>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div className="relative flex-1 w-full">
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-muted border-0 rounded-input focus:ring-2 focus:ring-brand focus:bg-card transition-all"
            />
            <svg
              className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-faint-foreground"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-info to-info-strong rounded-card p-6 text-white">
        ...
        <div className="bg-gradient-to-br from-brand to-brand-hover rounded-card p-6 text-white">
          <div className="flex items-center justify-between mb-2">
        ...
        <div className="bg-gradient-to-br from-success to-success-strong rounded-card p-6 text-white">
          <div className="flex items-center justify-between mb-2">
            <span className="text-white/80">Folders</span>
            <svg className="w-8 h-8 text-white/60" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-card rounded-card shadow-card p-6">
        {isLoading ? (
          <div className="text-center py-12">
            <div className="animate-spin mx-auto w-12 h-12 border-4 border-brand border-t-transparent rounded-full mb-4"></div>
            <p className="text-muted-foreground">Loading files...</p>
          </div>
        ) : filteredFiles.length === 0 ? (
          <div className="text-center py-12">
            <svg
              className="mx-auto w-16 h-16 text-faint-foreground mb-4"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
